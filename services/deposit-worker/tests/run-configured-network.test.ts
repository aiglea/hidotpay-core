...
test('configured network scan combines database address and asset allow-lists before crediting a finalized transfer', async () => {
  ...
  assert.deepEqual(result, { candidates: 1, fromBlock: 0, head: 20, reorgRecovered: false });
