...
export const WALLET_NETWORKS: readonly WalletNetwork[] = Object.freeze([
  ...
  { id: 'polygon-amoy', name: 'Polygon Amoy', badge: 'POL', assetCode: 'USDT', creditLive: false, description: '可取得地址 · 尚無已驗證測試 USDT，轉入不會入帳' },
  { id: 'arbitrum-sepolia', name: 'Arbitrum Sepolia', badge: 'ARB', assetCode: 'USDT', creditLive: false, description: '可取得地址 · 尚無已驗證測試 USDT，轉入不會入帳' },
  { id: 'optimism-sepolia', name: 'Optimism Sepolia', badge: 'OP', assetCode: 'USDT', creditLive: false, description: '可取得地址 · 尚無已驗證測試 USDT，轉入不會入帳' },
  ...
  { id: 'linea-sepolia', name: 'Linea Sepolia', badge: 'LINEA', assetCode: 'USDT', creditLive: false, description: '可取得地址 · 尚無已驗證測試 USDT，轉入不會入帳' },
