...
const ledgerApiBaseUrl = process.env.EXPO_PUBLIC_LEDGER_API_BASE_URL ?? 'https://hidotpay-native-ledger-staging.lgninhk.workers.dev';
const ledgerApiResource = process.env.EXPO_PUBLIC_LEDGER_API_RESOURCE ?? 'https://api-dev.hidotpay.com';
